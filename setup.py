...
if choice == 1:
  ...
  if cv == 1:
    ...
    destinatario = input("Gmail de la víctima: ")
    asunto = input("Asunto: ")
    contenido = input("Contenido: ")
    num_mensajes = int(input("Número de mensajes que quieres enviar: "))

    remitente = "axelxsx07@gmail.com"
    ...
    try:
        ...
        for i in range(num_mensajes):
            ...
            print(f"Correo {i+1} enviado a {destinatario}")

        server.quit()
        print(f"Todos los correos enviados exitosamente a {destinatario}")
